...
export const TitleCard: React.FC = () => {
  ...
  const badgeY = interpolate(badgeProgress, [0, 1], [14, 0]);
  const badgeOpacity = interpolate(badgeProgress, [0, 0.6], [0, 1], {
    extrapolateRight: "clamp",
  });
      ...
      >
        ...
        <div
          style={{
            fontSize: 32,
            fontFamily: FONT.sans,
            color: COLORS.vscodeBlue,
            marginTop: 6,
            opacity: tagOpacity,
            transform: `translateY(${tagY}px)`,
          }}
        >
          An open source package manager for Agent configuration
        </div>
