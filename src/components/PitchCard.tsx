...
export const PitchCard: React.FC = () => {
  ...
  const contentY = interpolate(entrance, [0, 1], [20, 0]);
  const contentOpacity = interpolate(entrance, [0, 0.6], [0, 1], {
    extrapolateRight: "clamp",
  });

  // Quiet shimmer on the GitHub URL — sweeps once
  const shimmerX = interpolate(frame, [50, 110], [-120, 120], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: Easing.inOut(Easing.quad),
  });
  const shimmerOpacity = interpolate(frame, [50, 60, 100, 110], [0, 1, 1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Reproducible, portable and composable Agent configuration
        </div>

        {/* Install commands — both platforms, no shimmer */}
        <div
          style={{
            display: "flex",
            gap: 16,
        ...
        {/* GitHub URL with logo and shimmer */}
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: `linear-gradient(105deg, transparent 35%, rgba(255,255,255,0.08) 49%, rgba(255,255,255,0.13) 50%, rgba(255,255,255,0.08) 51%, transparent 65%)`,
